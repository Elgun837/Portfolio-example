...
const ServicesCard = ({index,title,icon}) => {
    return (
      <Tilt className="xs:w-[250px] w-full">
        ...
        className='w-full green-bink-gradient p-[1px] rounded-[20px]
        sjadow-card'
        >
          <div 
          options={{
  ...
  return (
    <>
      ...
      >
        ...
        and Javascript, and expertaise in frameworks like React, Node.js,
        and Three.js. I'm a quick learner and collaborate closely with
        clients to create efficientm scalablem and user-friendly solutions
